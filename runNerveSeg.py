...
#     criterion = nn.NLLLoss2d()
    ...
    given_weight = torch.cuda.FloatTensor([1,8])
...
#     targets=torch.LongTensor(1000)
    ...
    path_patients_h5 = '/home/dongnie/warehouse/nerveSeg/nerveH5'
    path_patients_h5_test ='/home/dongnie/warehouse/nerveSeg/nerveH5'
#     batch_size=10
...
#             print 'running loss is ',running_loss
        ...
        if iter%opt.showTestPerformanceEvery==0: #test one subject  
            ...
            mr_test_itk=sitk.ReadImage(os.path.join(path_test,'NB_P045.nii.gz'))
            ct_test_itk=sitk.ReadImage(os.path.join(path_test,'NB_P045_FN.nii.gz'))
...
#             print 'matFA shape: ',matFA.shape
            matOut,_ = testOneSubject(matFA,matGT,2,[16,64,64],[16,64,64],[8,20,20],net,opt.prefixModelName+'%d.pt'%iter)
